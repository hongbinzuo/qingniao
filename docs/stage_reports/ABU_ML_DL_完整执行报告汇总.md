...
#### 阶段1: 数据准备相关
- `scripts/abu_record_match_history.py` - 记录匹配历史
- `scripts/abu_evaluate_signals.py` - 评估ABU信号
- `scripts/abu_backtest_pattern_matches.py` - 回测历史匹配
- `scripts/abu_init_ml_tables.py` - 初始化ML相关表
