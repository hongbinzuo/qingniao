...
if %ERRORLEVEL% NEQ 0 (
    ...
    echo 3. 请确保scripts\check_and_start_abu_system.py文件存在
    echo.
) else (
    echo.
    echo 设置成功！
