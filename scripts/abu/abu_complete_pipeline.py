...
示例：
  ...
  # 只执行OCR提取（其他步骤已完成）
  python scripts/abu/abu_complete_pipeline.py --skip step1,step2,step3 --ocr-limit 100
  
  # 跳过某些步骤
  python scripts/abu/abu_complete_pipeline.py --pdf book.pdf --skip step3,step4
        """
    )
